# Generated by Django 2.0.2 on 2018-03-09 18:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_dr_license_data', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gibdd_app.Category', verbose_name='Данные о доступных категорях')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('disqualif_status', models.CharField(choices=[('type1', 'Действующие'), ('type2', 'Лишение'), ('type3', 'Просрочены')], default='type1', max_length=20, verbose_name='Статус прав')),
                ...
                ('disqualif_cause', models.CharField(default='Вождение автомобиля под воздействием алкоголя', max_length=200, verbose_name='Причина лишения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registr_certificate_ecology_class', models.CharField(choices=[('class1', 'первый'), ('class2', 'второй'), ('class3', 'третий'), ('class4', 'четвертый'), ('class5', 'пятый'), ('class6', 'шестой'), ('class7', 'седьмой')], default='class4', max_length=20, verbose_name='Экологический класс')),
