# Generated by Django 2.0.2 on 2018-04-10 07:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_payment_fine', models.DateTimeField(blank=True, null=True, verbose_name='Дата оплаты штрафа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_end_dr_license', models.DateField(blank=True, default=gibdd_app.models.get_deadline, editable=False, null=True, verbose_name='Дата окончания действия ВУ')),
        ...
        migrations.AlterUniqueTogether(
            name='europrotocol',
            unique_together={('europrotocol_driver_1', 'europrotocol_driver_2'), ('europrotocol_insurance_1', 'europrotocol_insurance_2'), ('europrotocol_license_1', 'europrotocol_license_2'), ('europrotocol_car_1', 'europrotocol_car_2')},
        ),
        migrations.AlterUniqueTogether(
            name='autoschool_driver',
